...
## OUTPUT FORMAT:
Provide your analysis as structured markdown following the sections above. Use clear headers, bullet points, range estimates, and inline citations for EVERY numeric claim."""
